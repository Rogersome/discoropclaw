...
def generate_signal(klines):
    ...
    if   rsi < 30 and bb_pct < 0.2: signal, confidence = "BUY",  90
    elif rsi < 35 and bb_pct < 0.3: signal, confidence = "BUY",  80
    elif rsi > 70 and bb_pct > 0.8: signal, confidence = "SELL", 90
    elif rsi > 65 and bb_pct > 0.7: signal, confidence = "SELL", 80
